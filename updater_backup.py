...
class UpdateChecker:
    ...
    async def _download_and_install(self, download_url):
        ...
        try:
            ...
            messagebox.showerror("Update Error", f"Failed to update: {e}")    def _create_direct_launcher(self, installer_path):
        ...
        try:
            ...
            return False    async def check_updates_periodically(self, interval_hours=24):
