"""
Vitros Protocol Parser (ASTM E1394)
"""
from .astm_parser import ASTMParser

class VitrosParser(ASTMParser):
    """
    Parser for Vitros analyzers using ASTM E1394 protocol.
    """
    
    def __init__(self, db_manager, logger, gui_callback=None, config=None):
        super().__init__(db_manager, logger, gui_callback, config)
        self.log_info("Initialized Vitros parser (ASTM)")
